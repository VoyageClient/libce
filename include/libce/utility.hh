...
struct Utility {
     ...
     * on success. Returns SIZE_MAX on failure. On failure last_error
    ...
    /** Verify a ed25519 signature. Returns 0 on success. Returns
     * SIZE_MAX on failure or if the signature was invalid. On failure
