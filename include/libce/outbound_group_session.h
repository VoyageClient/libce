...
CE_EXPORT size_t olm_outbound_group_session_size(void);
 ...
 * bytes.
 */
CE_EXPORT OlmOutboundGroupSession * olm_outbound_group_session(
    void *memory
);
 ...
 * group session */
CE_EXPORT const char *olm_outbound_group_session_last_error(
...
CE_EXPORT size_t olm_clear_outbound_group_session(
    OlmOutboundGroupSession *session
);

/** Returns the number of bytes needed to store an outbound group session */
CE_EXPORT size_t olm_pickle_outbound_group_session_length(
    const OlmOutboundGroupSession *session
);
...
CE_EXPORT size_t olm_init_outbound_group_session_random_length(
    const OlmOutboundGroupSession *session
);
 ...
 */
CE_EXPORT size_t olm_init_outbound_group_session(
    OlmOutboundGroupSession *session,
 ...
 */
CE_EXPORT size_t olm_group_encrypt_message_length(
    OlmOutboundGroupSession *session,
 ...
 */
CE_EXPORT size_t olm_outbound_group_session_id_length(
    const OlmOutboundGroupSession *session
);
 ...
 * small.
 */
CE_EXPORT size_t olm_outbound_group_session_id(
    OlmOutboundGroupSession *session,
 ...
 * the next message.
 */
CE_EXPORT uint32_t olm_outbound_group_session_message_index(
    OlmOutboundGroupSession *session
);
 ...
 */
CE_EXPORT size_t olm_outbound_group_session_key_length(
    const OlmOutboundGroupSession *session
);
 ...
 */
CE_EXPORT size_t olm_outbound_group_session_key(
    OlmOutboundGroupSession *session,
