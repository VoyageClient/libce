 ...
 * SAS object. */
CE_EXPORT const char * olm_sas_last_error(
    const OlmSAS * sas
);
 ...
 */
CE_EXPORT size_t olm_create_sas(
    OlmSAS * sas,
    void * random, size_t random_length
);

/** The size of a public key in bytes. */
CE_EXPORT size_t olm_sas_pubkey_length(const OlmSAS * sas);
 ...
 */
CE_EXPORT size_t olm_sas_get_pubkey(
    OlmSAS * sas,
 ...
 */
CE_EXPORT size_t olm_sas_set_their_key(
    OlmSAS *sas,
 ...
 *
 */
CE_EXPORT int olm_sas_is_their_key_set(
    const OlmSAS *sas
);
 ...
 */
CE_EXPORT size_t olm_sas_generate_bytes(
    OlmSAS * sas,
...
CE_EXPORT size_t olm_sas_mac_length(
    const OlmSAS *sas
);
 ...
 * `olm_sas_last_error()` will be `OUTPUT_BUFFER_TOO_SMALL`.
 */
CE_EXPORT size_t olm_sas_calculate_mac(
    OlmSAS * sas,
...
CE_EXPORT size_t olm_sas_calculate_mac_fixed_base64(
    OlmSAS * sas,
    const void * input, size_t input_length,
    const void * info, size_t info_length,
    void * mac, size_t mac_length
...
CE_EXPORT size_t olm_sas_calculate_mac_long_kdf(
    OlmSAS * sas,
    const void * input, size_t input_length,
    const void * info, size_t info_length,
    void * mac, size_t mac_length
