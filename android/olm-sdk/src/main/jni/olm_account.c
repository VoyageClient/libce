...
OlmAccount* initializeAccountMemory()
{
    ...
    if (accountPtr)
    {
        ...
        LOGD("## initializeAccountMemory(): success - OLM account size=%lu",(long unsigned int)(accountSize));
    }
    else
    {
...
JNIEXPORT jlong OLM_ACCOUNT_FUNC_DEF(createNewAccountJni)(JNIEnv *env, jobject thiz)
{
    ...
    else
    {
        ...
        LOGD("## initNewAccount(): randomSize=%lu", (long unsigned int)(randomSize));
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                byteArrayRetValue = (*env)->NewByteArray(env, identityKeysLength);
                ...
                {
                    (*env)->SetByteArrayRegion(env, byteArrayRetValue, 0/*offset*/, identityKeysLength, (const jbyte*)identityKeysBytesPtr);
                    LOGD("## identityKeys(): success - result=%lu", (long unsigned int)(keysResult));
                }
            }
...
JNIEXPORT jlong OLM_ACCOUNT_FUNC_DEF(maxOneTimeKeysJni)(JNIEnv *env, jobject thiz)
{
    ...
    LOGD("## maxOneTimeKey(): Max keys=%lu", (long unsigned int)(maxKeys));
...
JNIEXPORT void OLM_ACCOUNT_FUNC_DEF(generateOneTimeKeysJni)(JNIEnv *env, jobject thiz, jint aNumberOfKeys)
{
    ...
    else
    {
        ...
        LOGD("## generateOneTimeKeysJni(): randomLength=%lu", (long unsigned int)(randomLength));
        ...
        else
        {
            ...
            {
                LOGD("## generateOneTimeKeysJni(): success - result=%lu", (long unsigned int)(result));
            }
        }
...
JNIEXPORT jbyteArray OLM_ACCOUNT_FUNC_DEF(oneTimeKeysJni)(JNIEnv *env, jobject thiz)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                // allocate the byte array to be returned to java
                byteArrayRetValue = (*env)->NewByteArray(env, keysLength);
                ...
                {
                    (*env)->SetByteArrayRegion(env, byteArrayRetValue, 0/*offset*/, keysLength, (const jbyte*)keysBytesPtr);
...
JNIEXPORT void OLM_ACCOUNT_FUNC_DEF(markOneTimeKeysAsPublishedJni)(JNIEnv *env, jobject thiz)
{
    ...
    else
    {
        ...
        {
            LOGD("## markOneTimeKeysAsPublishedJni(): success - retCode=%lu",(long unsigned int)(result));
        }
    }
...
JNIEXPORT void OLM_ACCOUNT_FUNC_DEF(generateFallbackKeyJni)(JNIEnv *env, jobject thiz)
{
    ...
    else
    {
        ...
        LOGD("## generateFallbackKeyJni(): randomLength=%lu", (long unsigned int)(randomLength));
        ...
        else
        {
            ...
            {
                LOGD("## generateFallbackKeyJni(): success - result=%lu", (long unsigned int)(result));
            }
        }
...
JNIEXPORT jbyteArray OLM_ACCOUNT_FUNC_DEF(signMessageJni)(JNIEnv *env, jobject thiz, jbyteArray aMessage)
{
    ...
    {
        int messageLength = (*env)->GetArrayLength(env, aMessage);
        jbyte* messageToSign = (*env)->GetByteArrayElements(env, aMessage, NULL);
        ...
        else
        {
            ...
            {
                LOGD("## signMessageJni(): success - retCode=%lu signatureLength=%lu", (long unsigned int)(resultSign), (long unsigned int)(signatureLength));

                signedMsgRetValueBuffer = (*env)->NewByteArray(env, signatureLength);
                (*env)->SetByteArrayRegion(env, signedMsgRetValueBuffer, 0 , signatureLength, (jbyte*)signedMsgPtr);
            }
        ...
        if (messageToSign)
        {
            (*env)->ReleaseByteArrayElements(env, aMessage, messageToSign, JNI_ABORT);
        }
    }
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                pickledDataRetValue = (*env)->NewByteArray(env, pickledLength);
                (*env)->SetByteArrayRegion(env, pickledDataRetValue, 0 , pickledLength, (jbyte*)pickledPtr);
            }
